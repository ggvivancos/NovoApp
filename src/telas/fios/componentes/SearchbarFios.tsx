...
const SearchbarFios: React.FC<SearchbarFiosProps> = ({
    onSearch,
    onSearchChange,
    onSearchSubmit,
    style,
    placeholder = "Pesquisar fios..." // Atualizado para "fios"
}) => {
